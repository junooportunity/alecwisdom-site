...
export default async function handler(req, res) {
  ...
  if (event.type === 'checkout.session.completed') {
    ...
    for (const item of lineItems.data) {
      ...
      // Send email via Resend (with direct R2 download links)
      try {
          ...
          html: `
            <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; background: #ffffff;">
              ...
              <div style="text-align: center; margin: 24px 0;">
                <a href="https://downloads.monosprosmonon.com/v1.1.1/Aletheia-Installer.pkg" style="display: inline-block; background: #0a0a0a; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 500;">
                  Download for macOS
                </a>
              </div>
              <div style="text-align: center; margin: 12px 0;">
                <a href="https://downloads.monosprosmonon.com/v1.1.1/Aletheia-Installer.exe" style="display: inline-block; background: #0a0a0a; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 500;">
